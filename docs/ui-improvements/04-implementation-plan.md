...
### Step 4.2 — S-3 photo-rail sidebar — **SKIPPED (owner decision 2026-07-18)**
- **Precondition (from 02):** confirm you actually use Dock Chrome regularly; skip entirely if not.
- **Outcome:** owner confirmed Dock Chrome is not part of the regular workflow — per the precondition, this step is dropped, not deferred. The rest of this section is kept for the record only.
